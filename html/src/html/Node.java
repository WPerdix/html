 ...
 * @invar | Arrays.stream(getChildren()
 */
public class Node {
	/**
	 ...
	 * 		| parent == null || Array.stream(parent.children).anyMatch(c -> c == this)
	 * @invar For each child of this node, the child's parent must equal this node.
	...
	public Node[] getChildren() {
		//return children; FOUT: REPTRESENTATION EXPOSURE
